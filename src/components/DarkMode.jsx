...
export default function Switch() {
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      {/* Toggle Track */}
      <div className="w-10 h-6  bg-gray-300 rounded-full  peer-checked:bg-gray-800 transition duration-300">
        {/* Sun Icon */}
        <div
          className={`absolute left-1 top-[5px] w-6 h-4 flex items-center justify-center  bg-gray-800 text-white rounded-full shadow-md transform transition ${
